...
def app():
    ...
    if uploaded_file is not None:
        ...
        st.write("Data yang ditampilkan berdasarkan file data produk yang diupload yaitu 1 tahun terakhir dari",rfm[rfm['Last Order Date'] == rfm['Last Order Date'].min()] ,"s/d",rfm[rfm['Last Order Date'] == rfm['Last Order Date'].max()])
        category = st.radio(
