...
def app():
    ...
    if uploaded_file is not None:
        ...
        st.write("Data yang ditampilkan berdasarkan file data produk yang diupload yaitu 1 tahun terakhir dari ",rfm[rfm['First Order Date'] == rfm['First Order Date'].min()].iloc[0])
        category = st.radio(
